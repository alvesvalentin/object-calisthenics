...
describe('MarsRover', () => {
    ...
    it.each([
        ...
        const rover = MarsRover.create(0, 0, from);
        rover.execute('R');
    ...
    it.each([
        ...
        const rover = MarsRover.create(start.x, start.y, start.direction);
